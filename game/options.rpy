...
define config.name = _("XEWNISTAN")
...
define gui.about = _p("""
여러분은 쿠르디스탄의 천재 프로그래머 다스니 박사와 리나트의 조수가 되어 그들의 실험을 도와주게 됩니다.
여러 캐릭터들로 꿈세계를 탐험하고 비밀을 파헤쳐 봅시다!
...
define config.save_directory = "XEWNISTAN-1776355099"
